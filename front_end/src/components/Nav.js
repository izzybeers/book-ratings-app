...
const Nav = () => {
    ...
    return (
        <div className = 'flex flex-nowrap whitespace-nowrap w-full h-[75px] sm:h-[50px] bg-blue-100 border-black-100 text-md md:text-lg text-blue-900 font-medium justify-center items-center'>
            <div className = 'px-2 sm:px-5 cursor-pointer ' onClick={() => navigate('/')}>
                <p>Home</p>
            </div>
            <div className = ' px-2 sm:px-5 cursor-pointer ' onClick={() => navigate('/friend-comparisons')}>
                <p>Analysis</p>
            </div>
            <div className = 'px-2 sm:px-5 cursor-pointer 'onClick={() => navigate('/add-new')}>
                <p>Add New</p>
            </div>
            <div className = 'px-2 sm:px-5 cursor-pointer ' onClick={() => navigate('/raw-data')}>
                <p>Raw Data</p>
            </div>
