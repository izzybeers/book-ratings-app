...
const BookSearch = (props) => {
    ...
    const handleSearch = async() => {
        ...
        if (queryText.length > 0)
        {
            ...
            setBookSearchResult(await response.json())
        }
    }
  ...
  return (
    <div className = 'flex justify-center'>
        <div className = 'relative flex flex-col border border-gray-800 border-2 h-[70vh] w-[95vw] bg-gray-100'>
            ...
            {showSearchResults &&
                (<div className = 'relative ml-4 overflow-y-auto'>
                    {bookSearchResult.map((result, index) => {
                        ...
                        return ( 
                        <div className = 'grid grid-cols-[3fr_2fr] overflow-y-auto'>
